...
function Home() {
 ...
 const fetchCounts = async () => {
   ...
   return (
    ...
    <div className='w-[100vw] h-[100vh] overflow-y-auto bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] relative'>
       <Nav/>
       <Sidebar/>

       <div className='w-[70vw] h-[100vh] absolute left-[25%] flex items-Start justify-start flex-col gap-[20px] lg:gap-[40px] py-[100px]'>
         <h1 className='lg:text-[35px] text-[25px] text-[#afe2f2]'>OneCart Admin Panel</h1>
