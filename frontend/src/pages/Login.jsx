     ...
     <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex flex-col items-center justify-start '>
         ...
         <div className='w-[100%] h-[100px] flex flex-col items-center justify-center gap-[10px]'>
            ...
            <span className='text-[25px]'>
               Welcome back to OneCart!
            </span>
         </div>
  
         <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
  
             <form action="" onSubmit={handleLogin} className='h-[90%] w-[90%] flex flex-col items-center justify-start gap-[20px]'>
                  
                  <div onClick={googleLogin} className='w-[80%] h-[50px]  bg-[#42656cae] rounded-lg flex items-center justify-center gap-[10px] py-[20px] cursor-pointer'>
                      <img className='w-[20px]' src={google} alt="" /> Log In with Google
                  </div>
                  ...
                  <div className='w-[90%] h-[400px] bottom-[12%] relative flex flex-col items-center justify-center gap-[15px]'>
                      ...
                      onChange={(e)=>setPassword(e.target.value)}/>
                       ...
                       {!show &&
                      <MdOutlineRemoveRedEye className='bottom-[57%] w-[20px] h-[20px] cursor-pointer absolute right-[5%]'
                       onClick={()=>setShow(prev=>!prev)}/>
                      }
                      {show &&
                        <IoEyeOffOutline className='bottom-[57%] w-[20px] h-[20px] cursor-pointer absolute right-[5%]'
                        onClick={()=>setShow(prev=>!prev)}/>
                      }
                      ...
                      <p className='flex gap-[10px] '>
                         ...
                         <span className='text-[17px] text-[#5555f6cf] font-semibold cursor-pointer' onClick={()=>navigate('/signup')}>
                             Sign Up
                         </span>
                      </p>
                  </div>
